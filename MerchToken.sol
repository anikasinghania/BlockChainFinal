...
contract MerchToken is ERC721, Ownable {
    ...
    function mintToken(
        ...
        uint256 user_address= uint256(msg.sender);
        uint256 curr_block_number = getTokens();
        uint256 block_and_add = user_address + curr_block_number;
        bytes32 hash1 = sha256(abi.encode(block_and_add));
